...
import { Shield, QrCode, MapPin, Zap } from 'lucide-react-native';
    ...
    <SafeAreaView style={s.safe} edges={['top']}>
      ...
      <View style={s.header}>
        ...
        <View style={s.rolePill}>
          <Shield color={C.warning} size={13} />
      ...
      <View style={s.content}>
        ...
        <View style={s.infoStrip}>
          ...
          <View style={s.infoItem}>
            ...
            <Text style={s.infoValue}>Admin</Text>
          </View>
          <View style={s.infoDivider} />
          <View style={s.infoItem}>
...
const s = StyleSheet.create({
  ...
  rolePill:     { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: 'rgba(245,158,11,0.12)', borderRadius: 20, paddingHorizontal: 12, paddingVertical: 6, borderWidth: 1, borderColor: 'rgba(245,158,11,0.25)' },
  rolePillText: { color: C.warning, fontSize: 12, fontWeight: '700' },
  ...
  infoStrip:    { flexDirection: 'row', backgroundColor: C.surface, borderRadius: 18, padding: 18, borderWidth: 1, borderColor: C.border, gap: 0 },
